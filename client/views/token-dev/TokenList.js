...
class TokenList extends React.Component {
  ...
  handleTokenDetails = (status, mail) => {
    if (status === "open")
      this.setState({ TokenDetailsVisibility: true, currentEmail: mail })
    else this.setState({ TokenDetailsVisibility: false })
  }
        ...
        mailsArr.map(mail => {
          return (
            <Media
              ...
              onClick={() => {
                this.handleTokenDetails("open", mail)
              }}
            >
    ...
    return (
      <div className="content-right">
        <div className="email-app-area">
          ...
          <TokenDetails
            handleTokenDetails={this.handleTokenDetails}
            currentStatus={this.state.TokenDetailsVisibility}
